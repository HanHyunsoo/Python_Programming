...
문제 3-1에서 만든 naver_closing_price를 이용해 해당 주에 종가를 기준으로
가장 높았던 가격을 출력하세요. (힌트: 리스트에서 최댓값을 찾는 함수는 max()이고, 화면에 출력하는 함수는 print()입니다.)
"""
...
문제 3-1에서 만든 naver_closing_price를 이용해 해당 주에 종가를 기준으로 
가장 낮았던 가격을 출력하세요. (힌트: 리스트에서 최솟값을 찾는 함수는 min()이고, 화면에 출력하는 함수는 print()입니다.)
"""
...
"""
print("가격차: " + str(max(naver_closing_price) - min(naver_closing_price)))
...
"""
print("수요일 종가: " + str(naver_closing_price[2]))
...
"""
naver_closing_price2 = {"09/07":474500, "09/08":461500, "09/09":50100, "09/10":500500, "09/11":488500}
