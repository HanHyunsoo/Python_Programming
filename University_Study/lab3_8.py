...
# fruits 안에 'a'라는 키가 있으면 True, 없으면 False를 출력하라.
print('a' in fruits)
print('체리' in fruits) # in은 key값에 존재하는지에 대한 boolena 값. '체리'는 key가 아님.
print('a' in fruits.keys())

# fruits의 values 중에 '복숭아'가 있으면 True, 없으면 False를 출력하라.
print('복숭아' in fruits.values())
f = sorted(fruits) # key의 순서에 따라 정렬된 key의 list를 반환
print(fruits)
print(f)
